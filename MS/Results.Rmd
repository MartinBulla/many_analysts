...
```{r Fig R, fig.width = 7*0.393701, fig.height = 12*0.393701}
...
o_m %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              table.width = pct(80)) #%>%  tab_source_note(source_note = o_m_source_note)
```
...
o_mt0g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.font.size = 14,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mt0g_source_note)
```
...
o_mt14g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mt14g_source_note)
```
...
o_mt0gs %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.hidden = TRUE,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mt0gs_source_note)
```
...
o_mw0g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.font.size = 14,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mw0g_source_note)
```
...
o_mw14g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.hidden = TRUE,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mw14g_source_note)
```
...
o_mw0gs %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.hidden = TRUE,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mw0gs_source_note)
```
...
o_mb0g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.font.size = 14,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mb0g_source_note)
```
...
o_mb14g %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.hidden = TRUE,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mb14g_source_note)
```
...
o_mb0gs %>% 
  ...
  tab_options(row_group.font.weight = "bold",
              ...
              column_labels.hidden = TRUE,
              row_group.font.size = 12,
              table.width = pct(80)) #%>% tab_source_note(source_note = o_mb0gs_source_note)
```
...
***
```{r Fig EP, fig.width=8, fig.height=8}
mortality_plot <-
