...
#### Tarsus model *with* interaction between sex and number of chicks moved
```{r, eval=FALSE, echo=TRUE}
    lmer(day_14_tarsus_length ~ 
         net_rearing_manipulation * chick_sex_molec + 
         brood_sex_ratio +
...
#### Weight model *with* interaction between sex and number of chicks moved
```{r, eval=FALSE, echo=TRUE}
    lmer(day_14_weight ~ 
         net_rearing_manipulation * chick_sex_molec + 
         brood_sex_ratio +
...
#### Body Mass Index model *with* interaction between sex and number of chicks moved
```{r, eval=FALSE, echo=TRUE}
    lmer(body_mass_index 
         net_rearing_manipulation * chick_sex_molec + 
         brood_sex_ratio +
