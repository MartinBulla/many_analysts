...
We have read the data description and metadata for ‘Many EcoEvo Analysts’ dataset provided by the [project coordinators of 'same data different analysts' project](https://osf.io/34fzc/) and **A PRIORY** decided upon the following analyses and procedures to answer the **key question**: 
