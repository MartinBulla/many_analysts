---
title: "A PRIORI DECIDED PROCEDURE for 'Many EcoEvo Analysts' project"
...
We have read the data description and metadata provided by the [project coordinators](https://osf.io/34fzc/) and **A PRIORI** decided upon the following analyses and procedures to answer the **key question**: 

**"To what extent is the growth of nestling blue tits (Cyanistes caeruleus) influenced by competition with siblings?"**

# 1. DATA EXPLORATION and ANALITICAL DECESIONS
...
###  Dependent variables
- change_chick_n = change in chick number from start of experiment till day 14 
...
```{r}    
    change_chick_n ~ net_rearing_manipulation * rear_Cs_at_start_of_rearing + 
