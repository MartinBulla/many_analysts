...
We have read the data description and metadata provided by the [project coordinators](https://osf.io/34fzc/) and **A PRIORY** decided upon the following analyses and procedures to answer the **key question**: 
